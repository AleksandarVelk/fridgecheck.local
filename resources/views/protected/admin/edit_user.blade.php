...
<div class="page-body">
                    ...
                    {!! Form::model($user, ['method' => 'PATCH','files' => true,'route' => ['admin.profiles.update', $user->id]]) !!}
                                ...
                                <div class="profile-header row">
                                    ...
                                    <div class="col-lg-5 col-md-8 col-sm-12 profile-info">
                                        ...
                                        <div class="header-information">
                                            ...
                                            {!! Form::select('account_type', $roles, $user_role, ['class' => 'selectpicker']) !!}
                                                            ...
                                                            <div class="col-sm-6">
                                                               <div class="form-group">
                                                                ...
                                                                <div class="form-group">Created
                                                                     ...
                                                                     {!! Form::input('date', 'updated_at',  date('Y-m-d', strtotime($user->updated_at)), ['class' => 'form-control']) !!}
                                                                </div>  
