                            ...
                            <li>
                                <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                    <div class="avatar" title="View your public profile">
                                        @if($user->image)
                                           <img src="{!! getenv('PATH_PROF_THUMB_IMG').$user->image !!}" class="user-avatar">
                                        @else
                                            <img src="{!! getenv('PATH_PROF_THUMB_IMG').'noprofimg.png' !!}" class="user-avatar">
                                        @endif
                                    </div>
                                    <section>
                                        <h2><span class="profile"><span>{!! $user->first_name.' '.$user->last_name !!}</span></span></h2>
                                    </section>
                                </a>
                                <!--Login Area Dropdown-->
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    <li class="username"><a>{!! $user->first_name.' '.$user->last_name !!}</a></li>
                                    <li class="email"><a>{!! $user->email !!}</a></li>
                                    <!--Avatar Area-->
                                    <li>
                                        <div class="avatar-area">
                                            @if($user->image)
                                               <img src="{!! getenv('PATH_PROF_THUMB_IMG').$user->image !!}" class="avatar">
                                            @else
                                                <img src="{!! getenv('PATH_PROF_THUMB_IMG').'noprofimg.png' !!}" class="avatar">
                                            @endif
                                    ...
                                    @if ($user->inRole('admins'))
                                        <a href="{{url("admin/profiles/{$user['id']}")}}" class="pull-left">Profile</a>
                                    @else
                                        <a href="{{url("moder/profile/{$user['id']}")}}" class="pull-left">Profile</a>
                                    @endif
